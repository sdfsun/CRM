<template>
    <div class="complaint_container">
        ...
        <div class="btns">
            <el-button type="primary" icon='el-icon-plus' @click='addComplaintRecord'>新建投诉记录</el-button>
            <el-button type="primary"  class='add_custom' @click='editComplaintRecord'>编辑</el-button>
        </div>
        <el-dialog title="投诉记录" :visible.sync="complaintDialogVisible" class='customRelationInfoDialog' @close='resetComplaintEdit'>
