...
renderTitle = function(instance)
{
    ...
    html += '<i class="el-icon-arrow-left pika-prev' + (prev ? '' : ' is-disabled') + '"></i>';
    html += '<i class="el-icon-arrow-right pika-next' + (next ? '' : ' is-disabled') + '"></i>';
 ...
 * Pikaday constructor
 */
export function Pikaday(options) {
    var self = this,
